...
import parquet.column.statistics.bloomfilter.BloomFilter;
...
//    out.write(MAGIC); // TODO: add a magic delimiter
  ...
  public void startColumn(ColumnDescriptor descriptor,
    ...
    currentStatistics = Statistics.getStatsBasedOnType(currentChunkType, statisticsOpts.getStatistics(descriptor));
  }
