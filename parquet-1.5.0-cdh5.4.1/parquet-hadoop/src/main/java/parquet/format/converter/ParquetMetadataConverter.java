...
import parquet.column.statistics.ColumnStatisticsOpts;
import parquet.column.statistics.bloomfilter.BloomFilterOpts;
import parquet.column.statistics.bloomfilter.BloomFilterStatistics;
import parquet.format.BloomFilter;
import parquet.format.BloomFilterStrategy;
...
//      columnChunk.meta_data.key_value_metadata = ; // nothing yet
  ...
  public static parquet.column.statistics.Statistics fromParquetStatistics(Statistics statistics,
      PrimitiveTypeName type) {
    parquet.column.statistics.Statistics stats;
    ...
    if (statistics != null) {
      ...
      stats =
          parquet.column.statistics.Statistics.getStatsBasedOnType(type, new ColumnStatisticsOpts(opts));
      ...
      stats = parquet.column.statistics.Statistics.getStatsBasedOnType(type, null);
    }
    return stats;
  }
