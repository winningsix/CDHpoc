...
public class TestColumnReaderImpl {
  ...
  public void test() {
    ...
    ColumnWriterV2 columnWriterV2 = new ColumnWriterV2(col, pageWriter, new ParquetProperties(1024,
        PARQUET_2_0, true, new StatisticsOpts()), 2048);
  ...
  public void testOptional() {
    ...
    ColumnWriterV2 columnWriterV2 =
        new ColumnWriterV2(col, pageWriter, new ParquetProperties(1024, PARQUET_2_0, true, new StatisticsOpts()),
            2048);
    for (int i = 0; i < rows; i++) {
