...
public abstract class Statistics<T extends Comparable<T>> {
   ...
   * @param columnStatisticsOpts the options for statistics filter
  ...
  public static Statistics getStatsBasedOnType(PrimitiveTypeName type,
    ...
    switch(type) {
    case INT32:
      return new IntStatistics(columnStatisticsOpts);
    case INT64:
      return new LongStatistics(columnStatisticsOpts);
    case FLOAT:
      return new FloatStatistics(columnStatisticsOpts);
    case DOUBLE:
      return new DoubleStatistics(columnStatisticsOpts);
    case BOOLEAN:
      return new BooleanStatistics();
    case BINARY:
      return new BinaryStatistics(columnStatisticsOpts);
    case INT96:
      return new BinaryStatistics(columnStatisticsOpts);
